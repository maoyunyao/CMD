...
def main_worker(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        loss_joint, loss_motion, loss_bone, loss_sim, top1_joint, top1_motion, top1_bone = train(train_loader, model, criterion, optimizer, epoch, args)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    progress = ProgressMeter(
        len(train_loader),
        [batch_time, losses_joint, losses_motion, losses_bone, losses_sim, top1_joint, top1_motion, top1_bone],
    ...
    for i, (input_v1, input_v2) in enumerate(train_loader):
        ...
        # compute output
        output, output_motion, output_bone, target, loss_sim = model(inputs[0], inputs[1])
        ...
        loss_bone = criterion(output_bone, target)

        loss = loss_joint + loss_motion + loss_bone + loss_sim

        losses.update(loss.item(), batch_size)
        losses_joint.update(loss_joint.item(), batch_size)
        losses_motion.update(loss_motion.item(), batch_size)
        losses_bone.update(loss_bone.item(), batch_size)
        ...
        acc1_bone, _ = accuracy(output_bone, target, topk=(1, 5))
    ...
    return losses_joint, losses_motion, losses_bone, losses_sim, top1_joint, top1_motion, top1_bone
